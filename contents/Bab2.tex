...
faktor yang dapat memengaruhi perilaku pemesanan penumpang. Gambar hasil dashboard
Python ditambahkan setelah aplikasi dijalankan.
...
pendapatan tiket menunjukkan pola yang berbeda: Platinum memiliki nilai tertinggi
sebesar Rp222.565, diikuti Gold Rp219.270 dan Basic Rp217.614.
...
Tiga dashboard Tableau telah dibangun dari keluaran data mart untuk mendukung
analisis operasional, komersial, dan loyalitas. Implementasi Python menggunakan
sumber data dan definisi metrik yang sama sebagai jalur pemeriksaan agregasi
melalui kode. Gambar hasil Python masih perlu ditambahkan setelah aplikasi
dijalankan agar implementasi kedua tools terdokumentasi pada laporan.
