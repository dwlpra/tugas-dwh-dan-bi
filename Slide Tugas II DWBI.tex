...
%$$$$$$$$$$$$$$$$
\title[Data Mart dan Visualisasinya]{Pembentukan Data Mart Kasus Bisnis dan Visualisasinya}
\subtitle{Konsep dan Implementasi}
\date{}
\author[Mustofa]{Khabib Mustofa \\
\small{\texttt{khabib@ugm.ac.id}} \\
\url{http://khabib.staff.ugm.ac.id}
}
